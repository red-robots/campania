<?php if( get_row_layout() == 'regular_text_content' ) {
  ...
  if($content_layout == 'fullwidth') { ?>
    <div data-group="<?php echo get_row_layout() ?>" id="repeatable-<?php echo get_row_layout() ?>--<?php echo $i ?>" class="repeatable repeatable-<?php echo get_row_layout() ?> fullwidth-text-content">
      <div class="wrapper">
  ...
  <?php } else if($content_layout == 'two_column') { ?>
    <div data-group="<?php echo get_row_layout() ?>" id="repeatable-<?php echo get_row_layout() ?>--<?php echo $i ?>" class="repeatable repeatable-<?php echo get_row_layout() ?> two-column-text-content">
      <div class="wrapper">
        <div class="flexwrap">
          <?php if ($column1) { ?>
            <div class="fcol col1">
